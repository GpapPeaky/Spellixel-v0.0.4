...
Init_t init_enemy_font(void){
    e_font = TTF_OpenFont("assets/font/FFFFORWA.TTF", FONT_SIZE); /* Relative to the .exe */
    if(!e_font){
        std:printf("FONT: %s\n ", SDL_GetError());
    }
...
Enemy chicken(int x, int y){
    ...
    chicken.sprite.Bullets.bullet_png = IMG_Load("assets/sprites/bullets/egg.png");
    ...
    chicken.sprite.sprite_bmp = IMG_Load("assets/sprites/chicken.png");
...
Enemy sheep(int x, int y){
    ...
    sheep.sprite.sprite_bmp = IMG_Load("assets/sprites/sheep.png");
...
Enemy john(int x, int y){
    ...
    john.sprite.sprite_bmp = IMG_Load("assets/sprites/john.png");
...
Enemy hilbert(int x, int y){
    ...
    hilbert.sprite.sprite_bmp = IMG_Load("assets/sprites/hilbert.png");
...
Enemy goblin(int x, int y){
    ...
    goblin.sprite.sprite_bmp = IMG_Load("assets/sprites/goblin.png");
    ...
    goblin.sprite.Bullets.bullet_png = IMG_Load("assets/sprites/bullets/goblin_punch.png");
...
Enemy villager(int x, int y){
    ...
    villager.sprite.sprite_bmp = IMG_Load("assets/sprites/villager.png");
